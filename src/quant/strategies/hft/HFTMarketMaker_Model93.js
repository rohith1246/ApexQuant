/**
 * HFTMarketMaker_Model93.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 93
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model93 {
  constructor(gamma = 0.080, sigma = 0.23) {
    this.modelId = 'HFT_MM_93';
...
module.exports = HFTMarketMaker_Model93;
