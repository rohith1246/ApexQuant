/**
 * HFTMarketMaker_Model32.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 32
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model32 {
  constructor(gamma = 0.070, sigma = 0.22) {
    this.modelId = 'HFT_MM_32';
...
module.exports = HFTMarketMaker_Model32;
