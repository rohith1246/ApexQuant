/**
 * HFTMarketMaker_Model84.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 84
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model84 {
  constructor(gamma = 0.090, sigma = 0.29) {
    this.modelId = 'HFT_MM_84';
...
module.exports = HFTMarketMaker_Model84;
