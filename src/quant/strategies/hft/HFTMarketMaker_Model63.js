/**
 * HFTMarketMaker_Model63.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 63
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model63 {
  constructor(gamma = 0.080, sigma = 0.23) {
    this.modelId = 'HFT_MM_63';
...
module.exports = HFTMarketMaker_Model63;
