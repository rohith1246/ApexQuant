/**
 * HFTMarketMaker_Model83.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 83
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model83 {
  constructor(gamma = 0.080, sigma = 0.28) {
    this.modelId = 'HFT_MM_83';
...
module.exports = HFTMarketMaker_Model83;
