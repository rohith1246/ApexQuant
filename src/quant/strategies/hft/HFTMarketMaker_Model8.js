/**
 * HFTMarketMaker_Model8.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 8
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model8 {
  constructor(gamma = 0.130, sigma = 0.28) {
    this.modelId = 'HFT_MM_8';
...
module.exports = HFTMarketMaker_Model8;
