/**
 * HFTMarketMaker_Model75.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 75
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model75 {
  constructor(gamma = 0.100, sigma = 0.20) {
    this.modelId = 'HFT_MM_75';
...
module.exports = HFTMarketMaker_Model75;
