/**
 * HFTMarketMaker_Model15.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 15
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model15 {
  constructor(gamma = 0.100, sigma = 0.20) {
    this.modelId = 'HFT_MM_15';
...
module.exports = HFTMarketMaker_Model15;
