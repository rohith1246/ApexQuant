/**
 * HFTMarketMaker_Model3.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 3
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model3 {
  constructor(gamma = 0.080, sigma = 0.23) {
    this.modelId = 'HFT_MM_3';
...
module.exports = HFTMarketMaker_Model3;
