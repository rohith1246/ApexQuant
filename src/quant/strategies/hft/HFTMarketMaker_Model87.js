/**
 * HFTMarketMaker_Model87.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 87
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model87 {
  constructor(gamma = 0.120, sigma = 0.32) {
    this.modelId = 'HFT_MM_87';
...
module.exports = HFTMarketMaker_Model87;
