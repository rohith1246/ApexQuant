/**
 * HFTMarketMaker_Model64.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 64
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model64 {
  constructor(gamma = 0.090, sigma = 0.24) {
    this.modelId = 'HFT_MM_64';
...
module.exports = HFTMarketMaker_Model64;
