/**
 * HFTMarketMaker_Model21.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 21
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model21 {
  constructor(gamma = 0.060, sigma = 0.26) {
    this.modelId = 'HFT_MM_21';
...
module.exports = HFTMarketMaker_Model21;
