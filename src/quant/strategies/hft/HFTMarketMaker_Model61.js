/**
 * HFTMarketMaker_Model61.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 61
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model61 {
  constructor(gamma = 0.060, sigma = 0.21) {
    this.modelId = 'HFT_MM_61';
...
module.exports = HFTMarketMaker_Model61;
