/**
 * HFTMarketMaker_Model95.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 95
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model95 {
  constructor(gamma = 0.100, sigma = 0.25) {
    this.modelId = 'HFT_MM_95';
...
module.exports = HFTMarketMaker_Model95;
