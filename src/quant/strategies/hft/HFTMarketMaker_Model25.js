/**
 * HFTMarketMaker_Model25.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 25
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model25 {
  constructor(gamma = 0.100, sigma = 0.30) {
    this.modelId = 'HFT_MM_25';
...
module.exports = HFTMarketMaker_Model25;
