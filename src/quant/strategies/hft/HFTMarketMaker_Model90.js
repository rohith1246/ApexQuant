/**
 * HFTMarketMaker_Model90.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 90
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model90 {
  constructor(gamma = 0.050, sigma = 0.20) {
    this.modelId = 'HFT_MM_90';
...
module.exports = HFTMarketMaker_Model90;
