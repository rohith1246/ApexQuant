/**
 * HFTMarketMaker_Model28.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 28
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model28 {
  constructor(gamma = 0.130, sigma = 0.33) {
    this.modelId = 'HFT_MM_28';
...
module.exports = HFTMarketMaker_Model28;
