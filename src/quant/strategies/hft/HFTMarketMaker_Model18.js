/**
 * HFTMarketMaker_Model18.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 18
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model18 {
  constructor(gamma = 0.130, sigma = 0.23) {
    this.modelId = 'HFT_MM_18';
...
module.exports = HFTMarketMaker_Model18;
