/**
 * HFTMarketMaker_Model66.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 66
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model66 {
  constructor(gamma = 0.110, sigma = 0.26) {
    this.modelId = 'HFT_MM_66';
...
module.exports = HFTMarketMaker_Model66;
