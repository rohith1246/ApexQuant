/**
 * HFTMarketMaker_Model88.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 88
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model88 {
  constructor(gamma = 0.130, sigma = 0.33) {
    this.modelId = 'HFT_MM_88';
...
module.exports = HFTMarketMaker_Model88;
