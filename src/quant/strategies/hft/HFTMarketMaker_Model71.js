/**
 * HFTMarketMaker_Model71.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 71
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model71 {
  constructor(gamma = 0.060, sigma = 0.31) {
    this.modelId = 'HFT_MM_71';
...
module.exports = HFTMarketMaker_Model71;
