/**
 * HFTMarketMaker_Model20.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 20
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model20 {
  constructor(gamma = 0.050, sigma = 0.25) {
    this.modelId = 'HFT_MM_20';
...
module.exports = HFTMarketMaker_Model20;
