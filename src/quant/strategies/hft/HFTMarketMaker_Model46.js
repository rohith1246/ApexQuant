/**
 * HFTMarketMaker_Model46.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 46
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model46 {
  constructor(gamma = 0.110, sigma = 0.21) {
    this.modelId = 'HFT_MM_46';
...
module.exports = HFTMarketMaker_Model46;
