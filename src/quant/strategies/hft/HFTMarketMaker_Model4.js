/**
 * HFTMarketMaker_Model4.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 4
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model4 {
  constructor(gamma = 0.090, sigma = 0.24) {
    this.modelId = 'HFT_MM_4';
...
module.exports = HFTMarketMaker_Model4;
