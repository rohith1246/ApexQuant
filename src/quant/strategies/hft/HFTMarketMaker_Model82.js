/**
 * HFTMarketMaker_Model82.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 82
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model82 {
  constructor(gamma = 0.070, sigma = 0.27) {
    this.modelId = 'HFT_MM_82';
...
module.exports = HFTMarketMaker_Model82;
