/**
 * HFTMarketMaker_Model76.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 76
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model76 {
  constructor(gamma = 0.110, sigma = 0.21) {
    this.modelId = 'HFT_MM_76';
...
module.exports = HFTMarketMaker_Model76;
