/**
 * HFTMarketMaker_Model37.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 37
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model37 {
  constructor(gamma = 0.120, sigma = 0.27) {
    this.modelId = 'HFT_MM_37';
...
module.exports = HFTMarketMaker_Model37;
