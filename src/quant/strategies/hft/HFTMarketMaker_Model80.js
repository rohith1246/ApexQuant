/**
 * HFTMarketMaker_Model80.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 80
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model80 {
  constructor(gamma = 0.050, sigma = 0.25) {
    this.modelId = 'HFT_MM_80';
...
module.exports = HFTMarketMaker_Model80;
