/**
 * HFTMarketMaker_Model27.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 27
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model27 {
  constructor(gamma = 0.120, sigma = 0.32) {
    this.modelId = 'HFT_MM_27';
...
module.exports = HFTMarketMaker_Model27;
