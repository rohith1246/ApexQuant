/**
 * HFTMarketMaker_Model92.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 92
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model92 {
  constructor(gamma = 0.070, sigma = 0.22) {
    this.modelId = 'HFT_MM_92';
...
module.exports = HFTMarketMaker_Model92;
