/**
 * HFTMarketMaker_Model26.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 26
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model26 {
  constructor(gamma = 0.110, sigma = 0.31) {
    this.modelId = 'HFT_MM_26';
...
module.exports = HFTMarketMaker_Model26;
