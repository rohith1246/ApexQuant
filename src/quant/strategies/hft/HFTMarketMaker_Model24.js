/**
 * HFTMarketMaker_Model24.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 24
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model24 {
  constructor(gamma = 0.090, sigma = 0.29) {
    this.modelId = 'HFT_MM_24';
...
module.exports = HFTMarketMaker_Model24;
