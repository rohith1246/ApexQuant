/**
 * HFTMarketMaker_Model5.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 5
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model5 {
  constructor(gamma = 0.100, sigma = 0.25) {
    this.modelId = 'HFT_MM_5';
...
module.exports = HFTMarketMaker_Model5;
