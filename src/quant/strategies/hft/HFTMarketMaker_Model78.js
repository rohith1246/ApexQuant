/**
 * HFTMarketMaker_Model78.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 78
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model78 {
  constructor(gamma = 0.130, sigma = 0.23) {
    this.modelId = 'HFT_MM_78';
...
module.exports = HFTMarketMaker_Model78;
