/**
 * HFTMarketMaker_Model30.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 30
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model30 {
  constructor(gamma = 0.050, sigma = 0.20) {
    this.modelId = 'HFT_MM_30';
...
module.exports = HFTMarketMaker_Model30;
