/**
 * HFTMarketMaker_Model86.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 86
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model86 {
  constructor(gamma = 0.110, sigma = 0.31) {
    this.modelId = 'HFT_MM_86';
...
module.exports = HFTMarketMaker_Model86;
