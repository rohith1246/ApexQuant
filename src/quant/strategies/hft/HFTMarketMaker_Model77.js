/**
 * HFTMarketMaker_Model77.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 77
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model77 {
  constructor(gamma = 0.120, sigma = 0.22) {
    this.modelId = 'HFT_MM_77';
...
module.exports = HFTMarketMaker_Model77;
