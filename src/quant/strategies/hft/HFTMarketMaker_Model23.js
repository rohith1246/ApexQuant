/**
 * HFTMarketMaker_Model23.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 23
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model23 {
  constructor(gamma = 0.080, sigma = 0.28) {
    this.modelId = 'HFT_MM_23';
...
module.exports = HFTMarketMaker_Model23;
