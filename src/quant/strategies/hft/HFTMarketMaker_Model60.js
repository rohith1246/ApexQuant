/**
 * HFTMarketMaker_Model60.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 60
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model60 {
  constructor(gamma = 0.050, sigma = 0.20) {
    this.modelId = 'HFT_MM_60';
...
module.exports = HFTMarketMaker_Model60;
