/**
 * HFTMarketMaker_Model38.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 38
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model38 {
  constructor(gamma = 0.130, sigma = 0.28) {
    this.modelId = 'HFT_MM_38';
...
module.exports = HFTMarketMaker_Model38;
