/**
 * HFTMarketMaker_Model81.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 81
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model81 {
  constructor(gamma = 0.060, sigma = 0.26) {
    this.modelId = 'HFT_MM_81';
...
module.exports = HFTMarketMaker_Model81;
