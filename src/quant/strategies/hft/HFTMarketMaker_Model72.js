/**
 * HFTMarketMaker_Model72.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 72
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model72 {
  constructor(gamma = 0.070, sigma = 0.32) {
    this.modelId = 'HFT_MM_72';
...
module.exports = HFTMarketMaker_Model72;
