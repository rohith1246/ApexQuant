/**
 * HFTMarketMaker_Model91.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 91
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model91 {
  constructor(gamma = 0.060, sigma = 0.21) {
    this.modelId = 'HFT_MM_91';
...
module.exports = HFTMarketMaker_Model91;
