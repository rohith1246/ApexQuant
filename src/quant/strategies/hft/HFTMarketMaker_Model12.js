/**
 * HFTMarketMaker_Model12.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 12
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model12 {
  constructor(gamma = 0.070, sigma = 0.32) {
    this.modelId = 'HFT_MM_12';
...
module.exports = HFTMarketMaker_Model12;
