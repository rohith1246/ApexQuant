/**
 * HFTMarketMaker_Model1.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 1
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model1 {
  constructor(gamma = 0.060, sigma = 0.21) {
    this.modelId = 'HFT_MM_1';
...
module.exports = HFTMarketMaker_Model1;
