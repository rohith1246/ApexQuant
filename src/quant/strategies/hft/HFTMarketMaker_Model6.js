/**
 * HFTMarketMaker_Model6.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 6
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model6 {
  constructor(gamma = 0.110, sigma = 0.26) {
    this.modelId = 'HFT_MM_6';
...
module.exports = HFTMarketMaker_Model6;
