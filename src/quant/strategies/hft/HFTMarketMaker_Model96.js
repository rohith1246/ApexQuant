/**
 * HFTMarketMaker_Model96.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 96
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model96 {
  constructor(gamma = 0.110, sigma = 0.26) {
    this.modelId = 'HFT_MM_96';
...
module.exports = HFTMarketMaker_Model96;
