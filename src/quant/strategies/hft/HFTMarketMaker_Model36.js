/**
 * HFTMarketMaker_Model36.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 36
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model36 {
  constructor(gamma = 0.110, sigma = 0.26) {
    this.modelId = 'HFT_MM_36';
...
module.exports = HFTMarketMaker_Model36;
