/**
 * HFTMarketMaker_Model73.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 73
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model73 {
  constructor(gamma = 0.080, sigma = 0.33) {
    this.modelId = 'HFT_MM_73';
...
module.exports = HFTMarketMaker_Model73;
