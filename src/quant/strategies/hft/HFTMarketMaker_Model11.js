/**
 * HFTMarketMaker_Model11.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 11
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model11 {
  constructor(gamma = 0.060, sigma = 0.31) {
    this.modelId = 'HFT_MM_11';
...
module.exports = HFTMarketMaker_Model11;
