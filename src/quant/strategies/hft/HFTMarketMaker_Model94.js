/**
 * HFTMarketMaker_Model94.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 94
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model94 {
  constructor(gamma = 0.090, sigma = 0.24) {
    this.modelId = 'HFT_MM_94';
...
module.exports = HFTMarketMaker_Model94;
