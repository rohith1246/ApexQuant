/**
 * HFTMarketMaker_Model65.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 65
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model65 {
  constructor(gamma = 0.100, sigma = 0.25) {
    this.modelId = 'HFT_MM_65';
...
module.exports = HFTMarketMaker_Model65;
