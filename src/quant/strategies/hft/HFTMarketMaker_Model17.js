/**
 * HFTMarketMaker_Model17.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 17
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model17 {
  constructor(gamma = 0.120, sigma = 0.22) {
    this.modelId = 'HFT_MM_17';
...
module.exports = HFTMarketMaker_Model17;
