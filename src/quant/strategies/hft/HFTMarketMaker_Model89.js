/**
 * HFTMarketMaker_Model89.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 89
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model89 {
  constructor(gamma = 0.140, sigma = 0.34) {
    this.modelId = 'HFT_MM_89';
...
module.exports = HFTMarketMaker_Model89;
