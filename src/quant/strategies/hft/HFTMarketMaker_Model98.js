/**
 * HFTMarketMaker_Model98.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 98
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model98 {
  constructor(gamma = 0.130, sigma = 0.28) {
    this.modelId = 'HFT_MM_98';
...
module.exports = HFTMarketMaker_Model98;
