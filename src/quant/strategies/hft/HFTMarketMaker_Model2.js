/**
 * HFTMarketMaker_Model2.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 2
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model2 {
  constructor(gamma = 0.070, sigma = 0.22) {
    this.modelId = 'HFT_MM_2';
...
module.exports = HFTMarketMaker_Model2;
