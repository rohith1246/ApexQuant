/**
 * HFTMarketMaker_Model13.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 13
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model13 {
  constructor(gamma = 0.080, sigma = 0.33) {
    this.modelId = 'HFT_MM_13';
...
module.exports = HFTMarketMaker_Model13;
