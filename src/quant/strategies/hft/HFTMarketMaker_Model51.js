/**
 * HFTMarketMaker_Model51.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 51
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model51 {
  constructor(gamma = 0.060, sigma = 0.26) {
    this.modelId = 'HFT_MM_51';
...
module.exports = HFTMarketMaker_Model51;
