/**
 * HFTMarketMaker_Model9.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 9
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model9 {
  constructor(gamma = 0.140, sigma = 0.29) {
    this.modelId = 'HFT_MM_9';
...
module.exports = HFTMarketMaker_Model9;
