/**
 * HFTMarketMaker_Model14.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 14
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model14 {
  constructor(gamma = 0.090, sigma = 0.34) {
    this.modelId = 'HFT_MM_14';
...
module.exports = HFTMarketMaker_Model14;
