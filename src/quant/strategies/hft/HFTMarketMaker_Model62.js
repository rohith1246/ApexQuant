/**
 * HFTMarketMaker_Model62.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 62
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model62 {
  constructor(gamma = 0.070, sigma = 0.22) {
    this.modelId = 'HFT_MM_62';
...
module.exports = HFTMarketMaker_Model62;
