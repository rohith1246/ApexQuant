/**
 * HFTMarketMaker_Model53.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 53
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model53 {
  constructor(gamma = 0.080, sigma = 0.28) {
    this.modelId = 'HFT_MM_53';
...
module.exports = HFTMarketMaker_Model53;
