/**
 * HFTMarketMaker_Model97.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 97
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model97 {
  constructor(gamma = 0.120, sigma = 0.27) {
    this.modelId = 'HFT_MM_97';
...
module.exports = HFTMarketMaker_Model97;
