/**
 * HFTMarketMaker_Model100.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 100
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model100 {
  constructor(gamma = 0.050, sigma = 0.30) {
    this.modelId = 'HFT_MM_100';
...
module.exports = HFTMarketMaker_Model100;
