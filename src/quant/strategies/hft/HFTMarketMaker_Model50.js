/**
 * HFTMarketMaker_Model50.js - Avellaneda-Stoikov Microstructure Market Making Model
 * HFT Model Index: 50
 * Part of ApexQuant Institutional Quantitative Suite
 */

class HFTMarketMaker_Model50 {
  constructor(gamma = 0.050, sigma = 0.25) {
    this.modelId = 'HFT_MM_50';
...
module.exports = HFTMarketMaker_Model50;
