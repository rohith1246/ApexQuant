/**
 * Strategy_Equity_KaufmanAMA_OBV_Alpha56.js - Quantitative Trading Strategy
...
class Strategy_Equity_KaufmanAMA_OBV_Alpha56 {
  constructor(config = {}) {
    this.name = 'Strategy_Equity_KaufmanAMA_OBV_Alpha56';
    this.assetClass = 'Equity';
    this.targetRegime = 'HighVolatilityMeanReverting';
    this.fastWindow = config.fastWindow || 21;
    this.slowWindow = config.slowWindow || 46;
...
module.exports = Strategy_Equity_KaufmanAMA_OBV_Alpha56;
