/**
 * Strategy_FixedIncome_RSI_Donchian_Alpha20.js - Quantitative Trading Strategy
 * Target Asset Class: FixedIncome | Market Regime: HighVolatilityMeanReverting
 * Alpha Signal: Cross-validation of RSI with Donchian
 * Part of ApexQuant Institutional Quantitative Suite
 */

class Strategy_FixedIncome_RSI_Donchian_Alpha20 {
  constructor(config = {}) {
    this.name = 'Strategy_FixedIncome_RSI_Donchian_Alpha20';
    this.assetClass = 'FixedIncome';
    this.targetRegime = 'HighVolatilityMeanReverting';
    this.fastWindow = config.fastWindow || 15;
    this.slowWindow = config.slowWindow || 50;
...
module.exports = Strategy_FixedIncome_RSI_Donchian_Alpha20;
