/**
 * Strategy_Index_MFI_MACD_Alpha78.js - Quantitative Trading Strategy
...
class Strategy_Index_MFI_MACD_Alpha78 {
  constructor(config = {}) {
    this.name = 'Strategy_Index_MFI_MACD_Alpha78';
...
module.exports = Strategy_Index_MFI_MACD_Alpha78;
