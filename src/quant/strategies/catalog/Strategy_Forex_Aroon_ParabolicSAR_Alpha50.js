/**
 * Strategy_Forex_Aroon_ParabolicSAR_Alpha50.js - Quantitative Trading Strategy
...
class Strategy_Forex_Aroon_ParabolicSAR_Alpha50 {
  constructor(config = {}) {
    this.name = 'Strategy_Forex_Aroon_ParabolicSAR_Alpha50';
    this.assetClass = 'Forex';
    this.targetRegime = 'HighVolatilityMeanReverting';
    this.fastWindow = config.fastWindow || 15;
    this.slowWindow = config.slowWindow || 40;
...
module.exports = Strategy_Forex_Aroon_ParabolicSAR_Alpha50;
