/**
 * Strategy_Commodity_Vortex_MFI_Alpha35.js - Quantitative Trading Strategy
...
class Strategy_Commodity_Vortex_MFI_Alpha35 {
  constructor(config = {}) {
    this.name = 'Strategy_Commodity_Vortex_MFI_Alpha35';
    this.assetClass = 'Commodity';
    this.targetRegime = 'CrisisLiquidityContagion';
    this.fastWindow = config.fastWindow || 15;
    this.slowWindow = config.slowWindow || 65;
...
module.exports = Strategy_Commodity_Vortex_MFI_Alpha35;
