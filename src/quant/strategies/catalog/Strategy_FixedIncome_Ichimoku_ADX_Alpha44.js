/**
 * Strategy_FixedIncome_Ichimoku_ADX_Alpha44.js - Quantitative Trading Strategy
 * Target Asset Class: FixedIncome | Market Regime: HighVolatilityMeanReverting
 * Alpha Signal: Cross-validation of Ichimoku with ADX
 * Part of ApexQuant Institutional Quantitative Suite
 */

class Strategy_FixedIncome_Ichimoku_ADX_Alpha44 {
  constructor(config = {}) {
    this.name = 'Strategy_FixedIncome_Ichimoku_ADX_Alpha44';
    this.assetClass = 'FixedIncome';
    this.targetRegime = 'HighVolatilityMeanReverting';
    this.fastWindow = config.fastWindow || 24;
    this.slowWindow = config.slowWindow || 34;
...
module.exports = Strategy_FixedIncome_Ichimoku_ADX_Alpha44;
