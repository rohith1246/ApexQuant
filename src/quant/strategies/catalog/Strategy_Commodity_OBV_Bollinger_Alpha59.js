/**
 * Strategy_Commodity_OBV_Bollinger_Alpha59.js - Quantitative Trading Strategy
...
class Strategy_Commodity_OBV_Bollinger_Alpha59 {
  constructor(config = {}) {
    this.name = 'Strategy_Commodity_OBV_Bollinger_Alpha59';
    this.assetClass = 'Commodity';
    this.targetRegime = 'CrisisLiquidityContagion';
    this.fastWindow = config.fastWindow || 24;
    this.slowWindow = config.slowWindow || 49;
...
module.exports = Strategy_Commodity_OBV_Bollinger_Alpha59;
