/**
 * Strategy_FixedIncome_KaufmanAMA_OBV_Alpha116.js - Quantitative Trading Strategy
 * Target Asset Class: FixedIncome | Market Regime: HighVolatilityMeanReverting
 * Alpha Signal: Cross-validation of KaufmanAMA with OBV
 * Part of ApexQuant Institutional Quantitative Suite
 */

class Strategy_FixedIncome_KaufmanAMA_OBV_Alpha116 {
  constructor(config = {}) {
    this.name = 'Strategy_FixedIncome_KaufmanAMA_OBV_Alpha116';
    this.assetClass = 'FixedIncome';
    this.targetRegime = 'HighVolatilityMeanReverting';
    this.fastWindow = config.fastWindow || 21;
    this.slowWindow = config.slowWindow || 66;
    this.riskBudgetPct = config.riskBudgetPct || 0.0150;
...
module.exports = Strategy_FixedIncome_KaufmanAMA_OBV_Alpha116;
