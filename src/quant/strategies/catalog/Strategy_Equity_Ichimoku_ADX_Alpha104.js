/**
 * Strategy_Equity_Ichimoku_ADX_Alpha104.js - Quantitative Trading Strategy
...
class Strategy_Equity_Ichimoku_ADX_Alpha104 {
  constructor(config = {}) {
    this.name = 'Strategy_Equity_Ichimoku_ADX_Alpha104';
    this.assetClass = 'Equity';
    this.targetRegime = 'HighVolatilityMeanReverting';
    this.fastWindow = config.fastWindow || 24;
    this.slowWindow = config.slowWindow || 54;
...
module.exports = Strategy_Equity_Ichimoku_ADX_Alpha104;
