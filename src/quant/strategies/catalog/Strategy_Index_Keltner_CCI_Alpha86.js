/**
 * Strategy_Index_Keltner_CCI_Alpha86.js - Quantitative Trading Strategy
 * Target Asset Class: Index | Market Regime: HighVolatilityMeanReverting
 * Alpha Signal: Cross-validation of Keltner with CCI
 * Part of ApexQuant Institutional Quantitative Suite
 */

class Strategy_Index_Keltner_CCI_Alpha86 {
  constructor(config = {}) {
    this.name = 'Strategy_Index_Keltner_CCI_Alpha86';
    this.assetClass = 'Index';
    this.targetRegime = 'HighVolatilityMeanReverting';
    this.fastWindow = config.fastWindow || 21;
    this.slowWindow = config.slowWindow || 36;
...
module.exports = Strategy_Index_Keltner_CCI_Alpha86;
