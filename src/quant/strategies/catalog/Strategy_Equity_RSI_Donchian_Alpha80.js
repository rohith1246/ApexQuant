/**
 * Strategy_Equity_RSI_Donchian_Alpha80.js - Quantitative Trading Strategy
...
class Strategy_Equity_RSI_Donchian_Alpha80 {
  constructor(config = {}) {
    this.name = 'Strategy_Equity_RSI_Donchian_Alpha80';
    this.assetClass = 'Equity';
    this.targetRegime = 'HighVolatilityMeanReverting';
    this.fastWindow = config.fastWindow || 15;
    this.slowWindow = config.slowWindow || 30;
...
module.exports = Strategy_Equity_RSI_Donchian_Alpha80;
