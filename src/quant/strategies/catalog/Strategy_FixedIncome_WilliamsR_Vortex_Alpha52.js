/**
 * Strategy_FixedIncome_WilliamsR_Vortex_Alpha52.js - Quantitative Trading Strategy
...
class Strategy_FixedIncome_WilliamsR_Vortex_Alpha52 {
  constructor(config = {}) {
    this.name = 'Strategy_FixedIncome_WilliamsR_Vortex_Alpha52';
    this.assetClass = 'FixedIncome';
    this.targetRegime = 'BreakoutExpansion';
    this.fastWindow = config.fastWindow || 17;
...
module.exports = Strategy_FixedIncome_WilliamsR_Vortex_Alpha52;
