/**
 * Strategy_Forex_MFI_MACD_Alpha98.js - Quantitative Trading Strategy
...
class Strategy_Forex_MFI_MACD_Alpha98 {
  constructor(config = {}) {
    this.name = 'Strategy_Forex_MFI_MACD_Alpha98';
    this.assetClass = 'Forex';
    this.targetRegime = 'HighVolatilityMeanReverting';
    this.fastWindow = config.fastWindow || 18;
    this.slowWindow = config.slowWindow || 48;
...
module.exports = Strategy_Forex_MFI_MACD_Alpha98;
