/**
 * Strategy_Commodity_Chaikin_TRIX_Alpha11.js - Quantitative Trading Strategy
...
class Strategy_Commodity_Chaikin_TRIX_Alpha11 {
  constructor(config = {}) {
    this.name = 'Strategy_Commodity_Chaikin_TRIX_Alpha11';
    this.assetClass = 'Commodity';
    this.targetRegime = 'CrisisLiquidityContagion';
    this.fastWindow = config.fastWindow || 21;
    this.slowWindow = config.slowWindow || 41;
...
module.exports = Strategy_Commodity_Chaikin_TRIX_Alpha11;
