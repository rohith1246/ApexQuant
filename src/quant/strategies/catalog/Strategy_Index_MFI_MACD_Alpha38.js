/**
 * Strategy_Index_MFI_MACD_Alpha38.js - Quantitative Trading Strategy
 * Target Asset Class: Index | Market Regime: HighVolatilityMeanReverting
 * Alpha Signal: Cross-validation of MFI with MACD
 * Part of ApexQuant Institutional Quantitative Suite
 */

class Strategy_Index_MFI_MACD_Alpha38 {
  constructor(config = {}) {
    this.name = 'Strategy_Index_MFI_MACD_Alpha38';
    this.assetClass = 'Index';
    this.targetRegime = 'HighVolatilityMeanReverting';
    this.fastWindow = config.fastWindow || 18;
    this.slowWindow = config.slowWindow || 68;
...
module.exports = Strategy_Index_MFI_MACD_Alpha38;
