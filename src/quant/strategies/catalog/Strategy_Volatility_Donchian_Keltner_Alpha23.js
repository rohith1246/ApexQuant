/**
 * Strategy_Volatility_Donchian_Keltner_Alpha23.js - Quantitative Trading Strategy
 * Target Asset Class: Volatility | Market Regime: CrisisLiquidityContagion
 * Alpha Signal: Cross-validation of Donchian with Keltner
 * Part of ApexQuant Institutional Quantitative Suite
 */

class Strategy_Volatility_Donchian_Keltner_Alpha23 {
  constructor(config = {}) {
    this.name = 'Strategy_Volatility_Donchian_Keltner_Alpha23';
    this.assetClass = 'Volatility';
    this.targetRegime = 'CrisisLiquidityContagion';
    this.fastWindow = config.fastWindow || 18;
    this.slowWindow = config.slowWindow || 53;
...
module.exports = Strategy_Volatility_Donchian_Keltner_Alpha23;
