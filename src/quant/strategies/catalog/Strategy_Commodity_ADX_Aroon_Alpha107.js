/**
 * Strategy_Commodity_ADX_Aroon_Alpha107.js - Quantitative Trading Strategy
...
class Strategy_Commodity_ADX_Aroon_Alpha107 {
  constructor(config = {}) {
    this.name = 'Strategy_Commodity_ADX_Aroon_Alpha107';
    this.assetClass = 'Commodity';
    this.targetRegime = 'CrisisLiquidityContagion';
    this.fastWindow = config.fastWindow || 12;
    this.slowWindow = config.slowWindow || 57;
...
module.exports = Strategy_Commodity_ADX_Aroon_Alpha107;
