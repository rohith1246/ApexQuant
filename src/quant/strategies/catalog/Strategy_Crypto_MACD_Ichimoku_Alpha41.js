/**
 * Strategy_Crypto_MACD_Ichimoku_Alpha41.js - Quantitative Trading Strategy
...
class Strategy_Crypto_MACD_Ichimoku_Alpha41 {
  constructor(config = {}) {
    this.name = 'Strategy_Crypto_MACD_Ichimoku_Alpha41';
    this.assetClass = 'Crypto';
    this.targetRegime = 'CrisisLiquidityContagion';
    this.fastWindow = config.fastWindow || 21;
    this.slowWindow = config.slowWindow || 31;
...
module.exports = Strategy_Crypto_MACD_Ichimoku_Alpha41;
