/**
 * Strategy_FixedIncome_RSI_Donchian_Alpha60.js - Quantitative Trading Strategy
...
class Strategy_FixedIncome_RSI_Donchian_Alpha60 {
  constructor(config = {}) {
    this.name = 'Strategy_FixedIncome_RSI_Donchian_Alpha60';
    this.assetClass = 'FixedIncome';
    this.targetRegime = 'BullishTrending';
    this.fastWindow = config.fastWindow || 10;
...
module.exports = Strategy_FixedIncome_RSI_Donchian_Alpha60;
