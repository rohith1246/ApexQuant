/**
 * Strategy_Derivatives_Supertrend_Stochastic_Alpha85.js - Quantitative Trading Strategy
...
class Strategy_Derivatives_Supertrend_Stochastic_Alpha85 {
  constructor(config = {}) {
    this.name = 'Strategy_Derivatives_Supertrend_Stochastic_Alpha85';
    this.assetClass = 'Derivatives';
    this.targetRegime = 'BearishTrending';
    this.fastWindow = config.fastWindow || 20;
...
module.exports = Strategy_Derivatives_Supertrend_Stochastic_Alpha85;
