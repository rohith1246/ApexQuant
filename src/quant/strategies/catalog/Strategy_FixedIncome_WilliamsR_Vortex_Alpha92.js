/**
 * Strategy_FixedIncome_WilliamsR_Vortex_Alpha92.js - Quantitative Trading Strategy
 * Target Asset Class: FixedIncome | Market Regime: HighVolatilityMeanReverting
 * Alpha Signal: Cross-validation of WilliamsR with Vortex
 * Part of ApexQuant Institutional Quantitative Suite
 */

class Strategy_FixedIncome_WilliamsR_Vortex_Alpha92 {
  constructor(config = {}) {
    this.name = 'Strategy_FixedIncome_WilliamsR_Vortex_Alpha92';
    this.assetClass = 'FixedIncome';
    this.targetRegime = 'HighVolatilityMeanReverting';
    this.fastWindow = config.fastWindow || 12;
    this.slowWindow = config.slowWindow || 42;
...
module.exports = Strategy_FixedIncome_WilliamsR_Vortex_Alpha92;
