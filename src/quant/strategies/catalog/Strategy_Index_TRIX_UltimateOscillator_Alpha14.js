/**
 * Strategy_Index_TRIX_UltimateOscillator_Alpha14.js - Quantitative Trading Strategy
 * Target Asset Class: Index | Market Regime: HighVolatilityMeanReverting
 * Alpha Signal: Cross-validation of TRIX with UltimateOscillator
 * Part of ApexQuant Institutional Quantitative Suite
 */

class Strategy_Index_TRIX_UltimateOscillator_Alpha14 {
  constructor(config = {}) {
    this.name = 'Strategy_Index_TRIX_UltimateOscillator_Alpha14';
    this.assetClass = 'Index';
    this.targetRegime = 'HighVolatilityMeanReverting';
    this.fastWindow = config.fastWindow || 24;
    this.slowWindow = config.slowWindow || 44;
    this.riskBudgetPct = config.riskBudgetPct || 0.0300;
...
module.exports = Strategy_Index_TRIX_UltimateOscillator_Alpha14;
