/**
 * Strategy_Forex_MFI_MACD_Alpha58.js - Quantitative Trading Strategy
...
class Strategy_Forex_MFI_MACD_Alpha58 {
  constructor(config = {}) {
    this.name = 'Strategy_Forex_MFI_MACD_Alpha58';
...
module.exports = Strategy_Forex_MFI_MACD_Alpha58;
