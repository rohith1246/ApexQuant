/**
 * Strategy_Derivatives_ParabolicSAR_KaufmanAMA_Alpha13.js - Quantitative Trading Strategy
 * Target Asset Class: Derivatives | Market Regime: BearishTrending
 * Alpha Signal: Cross-validation of ParabolicSAR with KaufmanAMA
 * Part of ApexQuant Institutional Quantitative Suite
 */

class Strategy_Derivatives_ParabolicSAR_KaufmanAMA_Alpha13 {
  constructor(config = {}) {
    this.name = 'Strategy_Derivatives_ParabolicSAR_KaufmanAMA_Alpha13';
    this.assetClass = 'Derivatives';
    this.targetRegime = 'BearishTrending';
...
module.exports = Strategy_Derivatives_ParabolicSAR_KaufmanAMA_Alpha13;
