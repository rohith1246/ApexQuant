/**
 * Strategy_FixedIncome_KaufmanAMA_OBV_Alpha76.js - Quantitative Trading Strategy
...
class Strategy_FixedIncome_KaufmanAMA_OBV_Alpha76 {
  constructor(config = {}) {
    this.name = 'Strategy_FixedIncome_KaufmanAMA_OBV_Alpha76';
    this.assetClass = 'FixedIncome';
    this.targetRegime = 'BreakoutExpansion';
    this.fastWindow = config.fastWindow || 11;
...
module.exports = Strategy_FixedIncome_KaufmanAMA_OBV_Alpha76;
