/**
 * Strategy_Forex_Bollinger_Supertrend_Alpha2.js - Quantitative Trading Strategy
...
class Strategy_Forex_Bollinger_Supertrend_Alpha2 {
  constructor(config = {}) {
    this.name = 'Strategy_Forex_Bollinger_Supertrend_Alpha2';
    this.assetClass = 'Forex';
    this.targetRegime = 'HighVolatilityMeanReverting';
    this.fastWindow = config.fastWindow || 12;
    this.slowWindow = config.slowWindow || 32;
...
module.exports = Strategy_Forex_Bollinger_Supertrend_Alpha2;
