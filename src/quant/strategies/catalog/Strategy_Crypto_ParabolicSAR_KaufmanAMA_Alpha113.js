/**
 * Strategy_Crypto_ParabolicSAR_KaufmanAMA_Alpha113.js - Quantitative Trading Strategy
 * Target Asset Class: Crypto | Market Regime: CrisisLiquidityContagion
 * Alpha Signal: Cross-validation of ParabolicSAR with KaufmanAMA
 * Part of ApexQuant Institutional Quantitative Suite
 */

class Strategy_Crypto_ParabolicSAR_KaufmanAMA_Alpha113 {
  constructor(config = {}) {
    this.name = 'Strategy_Crypto_ParabolicSAR_KaufmanAMA_Alpha113';
    this.assetClass = 'Crypto';
    this.targetRegime = 'CrisisLiquidityContagion';
    this.fastWindow = config.fastWindow || 18;
    this.slowWindow = config.slowWindow || 63;
...
module.exports = Strategy_Crypto_ParabolicSAR_KaufmanAMA_Alpha113;
