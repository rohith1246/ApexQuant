/**
 * Strategy_Index_Bollinger_Supertrend_Alpha62.js - Quantitative Trading Strategy
 * Target Asset Class: Index | Market Regime: HighVolatilityMeanReverting
 * Alpha Signal: Cross-validation of Bollinger with Supertrend
 * Part of ApexQuant Institutional Quantitative Suite
 */

class Strategy_Index_Bollinger_Supertrend_Alpha62 {
  constructor(config = {}) {
    this.name = 'Strategy_Index_Bollinger_Supertrend_Alpha62';
    this.assetClass = 'Index';
    this.targetRegime = 'HighVolatilityMeanReverting';
    this.fastWindow = config.fastWindow || 12;
    this.slowWindow = config.slowWindow || 52;
...
module.exports = Strategy_Index_Bollinger_Supertrend_Alpha62;
