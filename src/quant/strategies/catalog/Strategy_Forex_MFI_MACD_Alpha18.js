/**
 * Strategy_Forex_MFI_MACD_Alpha18.js - Quantitative Trading Strategy
...
class Strategy_Forex_MFI_MACD_Alpha18 {
  constructor(config = {}) {
    this.name = 'Strategy_Forex_MFI_MACD_Alpha18';
...
module.exports = Strategy_Forex_MFI_MACD_Alpha18;
