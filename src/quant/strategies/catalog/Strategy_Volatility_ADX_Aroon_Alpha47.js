/**
 * Strategy_Volatility_ADX_Aroon_Alpha47.js - Quantitative Trading Strategy
 * Target Asset Class: Volatility | Market Regime: CrisisLiquidityContagion
 * Alpha Signal: Cross-validation of ADX with Aroon
 * Part of ApexQuant Institutional Quantitative Suite
 */

class Strategy_Volatility_ADX_Aroon_Alpha47 {
  constructor(config = {}) {
    this.name = 'Strategy_Volatility_ADX_Aroon_Alpha47';
    this.assetClass = 'Volatility';
    this.targetRegime = 'CrisisLiquidityContagion';
    this.fastWindow = config.fastWindow || 12;
    this.slowWindow = config.slowWindow || 37;
...
module.exports = Strategy_Volatility_ADX_Aroon_Alpha47;
