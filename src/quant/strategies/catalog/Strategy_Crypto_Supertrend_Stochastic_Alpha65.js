/**
 * Strategy_Crypto_Supertrend_Stochastic_Alpha65.js - Quantitative Trading Strategy
...
class Strategy_Crypto_Supertrend_Stochastic_Alpha65 {
  constructor(config = {}) {
    this.name = 'Strategy_Crypto_Supertrend_Stochastic_Alpha65';
    this.assetClass = 'Crypto';
    this.targetRegime = 'CrisisLiquidityContagion';
    this.fastWindow = config.fastWindow || 15;
    this.slowWindow = config.slowWindow || 55;
...
module.exports = Strategy_Crypto_Supertrend_Stochastic_Alpha65;
