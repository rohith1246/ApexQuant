/**
 * Strategy_Index_TRIX_UltimateOscillator_Alpha54.js - Quantitative Trading Strategy
 * Target Asset Class: Index | Market Regime: BullishTrending
 * Alpha Signal: Cross-validation of TRIX with UltimateOscillator
 * Part of ApexQuant Institutional Quantitative Suite
 */

class Strategy_Index_TRIX_UltimateOscillator_Alpha54 {
  constructor(config = {}) {
    this.name = 'Strategy_Index_TRIX_UltimateOscillator_Alpha54';
    this.assetClass = 'Index';
    this.targetRegime = 'BullishTrending';
    this.fastWindow = config.fastWindow || 19;
...
module.exports = Strategy_Index_TRIX_UltimateOscillator_Alpha54;
