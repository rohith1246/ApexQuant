/**
 * Strategy_FixedIncome_KaufmanAMA_OBV_Alpha36.js - Quantitative Trading Strategy
...
class Strategy_FixedIncome_KaufmanAMA_OBV_Alpha36 {
  constructor(config = {}) {
    this.name = 'Strategy_FixedIncome_KaufmanAMA_OBV_Alpha36';
    this.assetClass = 'FixedIncome';
    this.targetRegime = 'BullishTrending';
    this.fastWindow = config.fastWindow || 16;
...
module.exports = Strategy_FixedIncome_KaufmanAMA_OBV_Alpha36;
