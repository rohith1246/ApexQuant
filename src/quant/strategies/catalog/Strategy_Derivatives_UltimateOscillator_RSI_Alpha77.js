/**
 * Strategy_Derivatives_UltimateOscillator_RSI_Alpha77.js - Quantitative Trading Strategy
...
class Strategy_Derivatives_UltimateOscillator_RSI_Alpha77 {
  constructor(config = {}) {
    this.name = 'Strategy_Derivatives_UltimateOscillator_RSI_Alpha77';
    this.assetClass = 'Derivatives';
    this.targetRegime = 'CrisisLiquidityContagion';
    this.fastWindow = config.fastWindow || 12;
    this.slowWindow = config.slowWindow || 67;
...
module.exports = Strategy_Derivatives_UltimateOscillator_RSI_Alpha77;
