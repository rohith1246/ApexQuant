/**
 * Strategy_Index_Aroon_ParabolicSAR_Alpha110.js - Quantitative Trading Strategy
 * Target Asset Class: Index | Market Regime: HighVolatilityMeanReverting
 * Alpha Signal: Cross-validation of Aroon with ParabolicSAR
 * Part of ApexQuant Institutional Quantitative Suite
 */

class Strategy_Index_Aroon_ParabolicSAR_Alpha110 {
  constructor(config = {}) {
    this.name = 'Strategy_Index_Aroon_ParabolicSAR_Alpha110';
    this.assetClass = 'Index';
    this.targetRegime = 'HighVolatilityMeanReverting';
    this.fastWindow = config.fastWindow || 15;
    this.slowWindow = config.slowWindow || 60;
...
module.exports = Strategy_Index_Aroon_ParabolicSAR_Alpha110;
