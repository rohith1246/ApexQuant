/**
 * Strategy_Commodity_Donchian_Keltner_Alpha83.js - Quantitative Trading Strategy
 * Target Asset Class: Commodity | Market Regime: CrisisLiquidityContagion
 * Alpha Signal: Cross-validation of Donchian with Keltner
 * Part of ApexQuant Institutional Quantitative Suite
 */

class Strategy_Commodity_Donchian_Keltner_Alpha83 {
  constructor(config = {}) {
    this.name = 'Strategy_Commodity_Donchian_Keltner_Alpha83';
    this.assetClass = 'Commodity';
    this.targetRegime = 'CrisisLiquidityContagion';
    this.fastWindow = config.fastWindow || 18;
    this.slowWindow = config.slowWindow || 33;
...
module.exports = Strategy_Commodity_Donchian_Keltner_Alpha83;
