/**
 * Strategy_Crypto_CCI_WilliamsR_Alpha89.js - Quantitative Trading Strategy
...
class Strategy_Crypto_CCI_WilliamsR_Alpha89 {
  constructor(config = {}) {
    this.name = 'Strategy_Crypto_CCI_WilliamsR_Alpha89';
    this.assetClass = 'Crypto';
    this.targetRegime = 'CrisisLiquidityContagion';
    this.fastWindow = config.fastWindow || 24;
    this.slowWindow = config.slowWindow || 39;
...
module.exports = Strategy_Crypto_CCI_WilliamsR_Alpha89;
