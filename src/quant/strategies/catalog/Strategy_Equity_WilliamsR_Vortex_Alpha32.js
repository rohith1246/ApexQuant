/**
 * Strategy_Equity_WilliamsR_Vortex_Alpha32.js - Quantitative Trading Strategy
...
class Strategy_Equity_WilliamsR_Vortex_Alpha32 {
  constructor(config = {}) {
    this.name = 'Strategy_Equity_WilliamsR_Vortex_Alpha32';
    this.assetClass = 'Equity';
    this.targetRegime = 'HighVolatilityMeanReverting';
    this.fastWindow = config.fastWindow || 12;
    this.slowWindow = config.slowWindow || 62;
...
module.exports = Strategy_Equity_WilliamsR_Vortex_Alpha32;
