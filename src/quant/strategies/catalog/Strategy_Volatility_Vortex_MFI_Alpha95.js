/**
 * Strategy_Volatility_Vortex_MFI_Alpha95.js - Quantitative Trading Strategy
 * Target Asset Class: Volatility | Market Regime: CrisisLiquidityContagion
 * Alpha Signal: Cross-validation of Vortex with MFI
 * Part of ApexQuant Institutional Quantitative Suite
 */

class Strategy_Volatility_Vortex_MFI_Alpha95 {
  constructor(config = {}) {
    this.name = 'Strategy_Volatility_Vortex_MFI_Alpha95';
    this.assetClass = 'Volatility';
    this.targetRegime = 'CrisisLiquidityContagion';
    this.fastWindow = config.fastWindow || 15;
    this.slowWindow = config.slowWindow || 45;
...
module.exports = Strategy_Volatility_Vortex_MFI_Alpha95;
