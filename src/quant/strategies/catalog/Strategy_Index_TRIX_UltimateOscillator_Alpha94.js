/**
 * Strategy_Index_TRIX_UltimateOscillator_Alpha94.js - Quantitative Trading Strategy
 * Target Asset Class: Index | Market Regime: BreakoutExpansion
 * Alpha Signal: Cross-validation of TRIX with UltimateOscillator
 * Part of ApexQuant Institutional Quantitative Suite
 */

class Strategy_Index_TRIX_UltimateOscillator_Alpha94 {
  constructor(config = {}) {
    this.name = 'Strategy_Index_TRIX_UltimateOscillator_Alpha94';
    this.assetClass = 'Index';
    this.targetRegime = 'BreakoutExpansion';
    this.fastWindow = config.fastWindow || 14;
...
module.exports = Strategy_Index_TRIX_UltimateOscillator_Alpha94;
