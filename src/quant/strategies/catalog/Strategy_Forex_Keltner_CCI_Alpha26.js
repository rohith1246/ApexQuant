/**
 * Strategy_Forex_Keltner_CCI_Alpha26.js - Quantitative Trading Strategy
...
class Strategy_Forex_Keltner_CCI_Alpha26 {
  constructor(config = {}) {
    this.name = 'Strategy_Forex_Keltner_CCI_Alpha26';
    this.assetClass = 'Forex';
    this.targetRegime = 'HighVolatilityMeanReverting';
    this.fastWindow = config.fastWindow || 21;
    this.slowWindow = config.slowWindow || 56;
...
module.exports = Strategy_Forex_Keltner_CCI_Alpha26;
